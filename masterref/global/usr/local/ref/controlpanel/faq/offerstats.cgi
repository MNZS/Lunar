...
<!-- QUESTION -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>Q.</b> Do you offer site statistic information?</font>

<p> 
<!-- ANSWER -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>A.</b> Yes. Lunar Hosting offers site statistics using Quantified Systems' Urchin software. The statistics are compiled on a daily basis and are cumulative allowing you to view information for a single day all the way through the entire year. Statistics are available upon request and require a one time setup fee of \$20.00. To enable statistics for your domain, please email support\@lunarhosting.net.</font>
