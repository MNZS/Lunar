...
<!-- QUESTION -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>Q.</b> How can I configure an e-mail address to have multiple recipients?</font>

<p> 
<!-- ANSWER -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>A.</b> In order for an email address at your domain to be delievered to multiple recipients, you should configure the address as a mailing group. Click on the link in the left hand column of your control panel that reads "Configure Mailing Groups".</font>
