...
<!-- QUESTION -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>Q.</b> How can I update my website using FTP?</font>

<p> 
<!-- ANSWER -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>A.</b> Use your favorite FTP client and connect to ftp.$domain. Log in using the FTP user account and password that you created when you first opened your account with Lunar Hosting. If you do not remember your username or password, please email support\@lunarmedia.net.<p>Once you have successfully logged into your site through FTP, place any files that you would like displayed on your website in the directory called /public_html/<p>A file called hello.html within /public_html/ will be accessible via the web at the following url: http:\/\/www.$domain\/hello.html<p>There are several FTP applications available for use in updating your website. One popular client is CuteFTP. A tutorial can be found by clicking <a href="http://www.lunareclipse.net/cuteftp.htm" target="_new"><font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1">here</font></a>.</font>
