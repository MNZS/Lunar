...
<!-- QUESTION -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>Q.</b> My website is down! Who do I call?.</font>

<p> 
<!-- ANSWER -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>A.</b> If a situation arises where your website becomes inaccessible, please email emergency\@lunarhosting.net for immediate attention. Please note that this email address should not be used in a non-critical situation. It is provided for your convenience as a method of accessing our oncall staff outside of normal working hours (9am-5pm US Central).</font>
