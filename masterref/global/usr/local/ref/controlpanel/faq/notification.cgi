...
<!-- QUESTION -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>Q.</b> Will I be notified prior to work being done on servers?</font>

<p> 
<!-- ANSWER -->
<font face="Verdana,Geneva,Arial,Helvetica,sans-serif" color="#CC3300" size="-1"><b>A.</b>For non-emergency maintenance, Lunar Hosting will send a letter of notification at least 48 hours in advance. The letter will include a brief description of the type of work being done, what effects, if any, customers should see and the hours during which maintenance will be scheduled.<p>Work that is being done during hours which fall into the company's fixed maintenance schedule will not be preceded by advance notification unless the work is known to cause a prolonged outage.<p>The following schedule is presented as a set of fixed maintenance times. Work during these hours will not require advance notification:<p>Mon-Fri : 12:00AM US Central - 4:00AM US Central<br>Sun : &nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;08:00PM US Central - 12:00AM US Central</font>
