...
~;
	...
	print qq~
		...
		<tr>
			<td bgcolor="$bg_light"><font face="Geneva, Arial, Helvetica" color="$bg_dark">Name:</font></td>
			<td bgcolor="$bg_light"><input name="Name" value="$name"></td>
		</tr>
		<tr>
			<td bgcolor="$bg_light" width="25%"><font face="Geneva, Arial, Helvetica" color="$bg_dark">Reply-To Address:</font></td>
			<td bgcolor="$bg_light"><input name="replyto" value="$replyto"></td>
		</tr>	
		<tr>
			<td bgcolor="$bg_light" valign="top"><font color="$bg_dark" face="Geneva, Arial, Helvetica">Signature</font></td>
			<td bgcolor="$bg_light"><textarea name="sig" rows="4" wrap="soft" cols="75">$sig</textarea></td>
		</tr>
		<tr>
			<td bgcolor="$bg_light"><font color="$bg_dark" face="Geneva, Arial, Helvetica">Messages Per Page:</font></td>
			<td bgcolor="$bg_light"><input name="messages" value="$show_messages" size=4></td>
		</tr>
		<tr>
			<td bgcolor="$bg_light" colspan="2"><font color="$bg_dark" face="Geneva, Arial, Helvetica" size="+2">Colors</font></td>
		</tr>
		<tr>
			<td bgcolor="$bg_light"><font color="$bg_dark" face="Geneva, Arial, Helvetica">Table Head Color:</font></td>
			<td bgcolor="$bg_light"><input name="tablehead" value="$table_head" size="12"></td>
		</tr>	
		<tr>
			<td bgcolor="$bg_light"><font color="$bg_dark" face="Geneva, Arial, Helvetica">Toolbar Color:</font></td>
			<td bgcolor="$bg_light"><input name="tablebg" value="$table_bg" size="12"></td>
		</tr>	
		<tr>
			<td bgcolor="$bg_light"><font color="$bg_dark" face="Geneva, Arial, Helvetica">Dark Row Color:</font></td>
			<td bgcolor="$bg_light"><input name="bgdark" value="$bg_dark" size="12"></td>
		</tr>	
		<tr>
			<td bgcolor="$bg_light"><font face="Geneva, Arial, Helvetica">Light Row Color:</font></td>
