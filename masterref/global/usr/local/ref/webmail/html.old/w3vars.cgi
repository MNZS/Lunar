      ...
      <table border="0" cellpadding="1" cellspacing="0" bgcolor="#000000" width="95%">
       <tr bgcolor="#FFFFFF">
		...
		<td width="50%" align="right" valign="bottom">
		 <font face="Geneva, Arial, Helvetica">($replyto)</font>
		</td>
	   </tr>
	   <tr>
		<td colspan="2">
			 ...
			 <table border="0" cellspacing="0" cellpadding="0" width="100%">
			  <tr valign=top>
			   <td align="left" width="92%">
			    Welcome!  Since this is your first time using W3Mail please fill out the following preferences.
			   </td>
...
sub welcome {
	if ($name) {
		print qq~<td align="center" valign="bottom"><font><b>Welcome $name, you have $messages messages!</b></font><br><font face="Geneva, Arial, Helvetica" size="-2">Inbox: $messages messages. $inboxsize bytes.</font></td>~;
	} else {
		print qq~<td align="center" valign="bottom"><font><b>Welcome, you have $messages messages!</b></font><br><font><nobr>Inbox: $messages messages. $inboxsize bytes.</nobr></font></td>~;
	}
}
