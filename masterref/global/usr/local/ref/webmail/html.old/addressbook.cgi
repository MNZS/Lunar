...
<tr bgcolor="#FFFFFF">
	<td width="50%" align="left" valign="bottom"><img src="$imageshttp/title_addressbook.gif" width="170" height="19" border="0" alt="Addressbook"></td>
...
if (!-e "$datadir/$mailserv/$user/addressbook") {
	print qq~<tr bgcolor="$table_bg"><td colspan="3"><font face="Geneva, Arial, Helvetica">No Contacts Present.</font></td></tr>\n~;
}
...
<a href="$cgidir/addressbook.cgi?mailserv=$mailserv&user=$user&func=import">Import Address Book</a>
</td></tr>
</table>
</div>
~;
