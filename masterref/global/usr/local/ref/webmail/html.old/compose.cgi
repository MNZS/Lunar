...
if ($type eq "Fwd") {
	print qq~
		<tr bgcolor="$bg_dark">
			<td><font face="Geneva, Arial, Helvetica" size="-1"><a href="javascript:SendTo('rcpt')">Recipient:</a></font></td>
...
print qq~
		<tr bgcolor="$bg_dark">
			<td><font face="Geneva, Arial, Helvetica" size="-1"><a href="javascript:SendTo('cc')">CC:</a></font></td>
...
print qq~
		...
		<tr bgcolor="$bg_dark">
			<td><font face="Geneva, Arial, Helvetica" size="-1"><a href="javascript:SendTo('bcc')">BCC:</a></font></td>
