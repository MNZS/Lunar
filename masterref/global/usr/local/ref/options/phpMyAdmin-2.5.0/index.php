<?php
/* $Id: index.php,v 1.46 2003/05/02 20:18:23 garvinhicking Exp $ */
...
<?php
    if ($cfg['QueryFrameJS']) {?>
        ...
        document.writeln('<frame src="left.php?<?php echo $url_query; ?>&amp;hash=<?php echo $phpmain_hash . $phpmain_hash_js; ?>" name="nav" frameborder="0" />');
        document.writeln('<frame src="queryframe.php?<?php echo $url_query; ?>&amp;hash=<?php echo $phpmain_hash . $phpmain_hash_js; ?>" name="queryframe" frameborder="0" />');
        </script>

        <noscript>
<?php } ?>
        <frame src="left.php?<?php echo $url_query; ?>&amp;hash=<?php echo $phpmain_hash; ?>" name="nav" frameborder="0" />
        <frame src="queryframe.php?<?php echo $url_query; ?>&amp;hash=<?php echo $phpmain_hash; ?>" name="queryframe" frameborder="0" />
...
?>
    <frame src="<?php echo (empty($db)) ? 'main.php' : $cfg['DefaultTabDatabase']; ?>?<?php echo $url_query; ?>" name="phpmain<?php echo $phpmain_hash; ?>" frameborder="1" />
