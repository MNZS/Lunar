...
$SEARCH_TEMPLATE{'en'} = '/www/DOMAIN/pub/search/match.html';
$SEARCH_TEMPLATE{'de'} = $TEMPLATE_DIR.'match_de.html';
$NO_MATCH_TEMPLATE{'en'} = '/www/DOMAIN/pub/search/no_match.html';
